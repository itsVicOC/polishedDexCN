...
const translate = value => terms.reduce((text, [en, zh]) => text.replace(new RegExp(`\\b${en.replace(/[.*+?^${}()|[\\]\\\\]/g, '\\\\$&')}\\b`, 'gi'), zh), String(value || ''))
...
for (const file of files) {
  ...
  guide.titleZh ||= translate(guide.title)
  guide.descriptionZh ||= translate(guide.description)
  guide.htmlZh ||= translate(guide.html)
